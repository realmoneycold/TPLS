                    ...
                    <div className="max-w-[1600px] mx-auto px-6 lg:px-10 h-[60px] flex items-center justify-between reveal-down">
                        ...
                        <div
                            ...
                            <div className="relative group cursor-pointer">
                              <button className="flex items-center px-5 py-2 text-[13px] font-medium text-white/60 hover:text-white hover:bg-white/10 rounded-full transition-colors">
                                Portals <iconify-icon icon="lucide:chevron-down" class="ml-1 text-[10px]"></iconify-icon>
                              </button>
                              <div className="absolute top-full right-0 mt-2 w-40 bg-[#151515] border border-white/10 rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all flex flex-col p-2 z-50">
                                <Link to="/" className="px-4 py-2 text-[13px] font-medium text-white/60 hover:text-white hover:bg-white/10 rounded-md transition-colors">Main Home</Link>
                                <Link to="/trading" className="px-4 py-2 text-[13px] font-medium text-white/60 hover:text-white hover:bg-white/10 rounded-md transition-colors">Trading</Link>
                                <Link to="/market-news" className="px-4 py-2 text-[13px] font-medium text-white/60 hover:text-white hover:bg-white/10 rounded-md transition-colors">Market</Link>
                                <Link to="/apparel" className="px-4 py-2 text-[13px] font-medium text-white/60 hover:text-white hover:bg-white/10 rounded-md transition-colors">Apparel</Link>
                              </div>
                            </div>
                        </div>
